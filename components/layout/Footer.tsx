...
const footerLinks = {
  Services: [
    { label: "Digital Strategy & Roadmap", href: "/services#digital-strategy" },
    { label: "Data Analytics", href: "/services#data-analytics" },
    { label: "AI Revenue Intelligence", href: "/services#ai-revenue" },
    { label: "Finance & Operations", href: "/services#finance-operations" },
  ],
  Company: [
    { label: "About Michelle", href: "/about" },
