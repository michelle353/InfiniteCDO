        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-slate-400 leading-relaxed">
              {siteConfig.credentials} — Fractional Chief Digital, Data & AI Officer
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-16 items-start">
            ...
            <div className="lg:col-span-2">
              {/* Photo block */}
              <div className="rounded-2xl overflow-hidden bg-gradient-to-br from-slate-800 to-slate-900 aspect-[3/4] shadow-2xl mb-8">
                <div className="h-full flex flex-col items-center justify-center">
                  <div className="w-28 h-28 rounded-full bg-gradient-to-br from-blue-500 to-cyan-400 flex items-center justify-center mb-4">
              ...
              <div className="bg-slate-50 rounded-2xl border border-slate-200 p-6 mb-6">
                <p className="text-xs font-semibold uppercase tracking-widest text-slate-400 mb-4">Credentials</p>
                <ul className="space-y-2.5">
                  {aboutContent.credentials.map((cred) => (
                    <li key={cred} className="flex items-center gap-2.5 text-sm text-slate-700">
              ...
              <div className="bg-slate-900 rounded-2xl p-6">
                <p className="text-xs font-semibold uppercase tracking-widest text-slate-400 mb-5">By the Numbers</p>
            ...
            <div className="lg:col-span-3 space-y-8">
              ...
              <div className="bg-blue-50 border border-blue-100 rounded-2xl p-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900 mb-2">{aboutContent.callout.heading}</h3>
                    <p className="text-slate-600 leading-relaxed">{aboutContent.callout.body}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="border-l-4 border-slate-200 pl-6">
                <p className="text-slate-500 italic leading-relaxed">{aboutContent.personal}</p>
              </div>
              ...
              <div className="bg-slate-900 rounded-2xl p-8 text-center">
                ...
                <p className="text-slate-400 mt-4 text-sm">— {siteConfig.founder}</p>
              </div>
            </div>
          </div>
        </div>
